...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = {
	  ...
	  RESET_NOTE: function RESET_NOTE(state) {
	    $.getJSON("vuex/note.json", function (result) {
	      console.log(result);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-0a9251ae/Toolbar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	var resetNote = exports.resetNote = function resetNote(_ref5) {
	  var dispatch = _ref5.dispatch;

	  dispatch('RESET_NOTE');
	};

	var toggleFavorite = exports.toggleFavorite = function toggleFavorite(_ref6) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-8f8471a6/NotesList.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	//           </button>
	//         </div>
	//         <div class="btn-group"><button @click="resetNote()">重置</button></div>
	//       </div>
	//     </div>
